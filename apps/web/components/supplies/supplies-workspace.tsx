...
const TABS = ['dashboard', 'requisitions', 'orders', 'stock', 'warehouse', 'registrations'] as const;
...
export function SuppliesWorkspace() {
  ...
  return <div className="space-y-4">
    ...
    <Tabs value={tab} onValueChange={setTab}><TabsList className="flex h-auto flex-wrap justify-start"><TabsTrigger value="dashboard">Painel</TabsTrigger>{canProcurement && <TabsTrigger value="requisitions">Requisições</TabsTrigger>}{canProcurementOverview && <TabsTrigger value="orders">Pedidos</TabsTrigger>}{canStock && <TabsTrigger value="stock">Estoque</TabsTrigger>}{canStock && <TabsTrigger value="warehouse">Almoxarifado</TabsTrigger>}<TabsTrigger value="registrations">Cadastros</TabsTrigger></TabsList>
