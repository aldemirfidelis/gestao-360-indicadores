...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/monthly-results', label: 'Reunião Mensal', description: 'Fechamento de resultados, pauta, ata e acompanhamento semanal', icon: Presentation, permissions: ['meetings:view', 'dashboard:view'] },
...
export const ROUTE_PERMISSIONS: Array<{ prefix: string; permissions: string[]; exact?: boolean }> = [
  ...
  { prefix: '/monthly-results', permissions: ['meetings:view', 'dashboard:view'] },
