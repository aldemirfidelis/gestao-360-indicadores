...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/gestao-premio/indicadores', label: 'Indicadores', description: 'Parametrização (metas, zeros, pesos e faixas) sobre os indicadores da plataforma', icon: Target, permissions: ['prize:view'] },
      { href: '/gestao-premio/realizado', label: 'Realizado', description: 'Sincronização dos Lançamentos, conferência e Previsto × Realizado', icon: TrendingUp, permissions: ['prize:view'] },
      ...
      { href: '/gestao-premio/ajustes', label: 'Ajustes e Exceções', description: 'Ajustes manuais, exceções, transitoriedade e regras de moderador', icon: SlidersHorizontal, permissions: ['prize:view'] },
  ...
  {
    heading: 'Seguranca Patrimonial',
    description: 'Portarias, acessos, rondas, ocorrencias e permanencia',
    intent: 'management',
    icon: ShieldCheck,
    items: [
      { href: '/seguranca-patrimonial', label: 'Visao Geral', description: 'Resumo operacional e executivo de portarias', icon: LayoutDashboard, permissions: ['asset-security:view'] },
      { href: '/seguranca-patrimonial?tab=operation', label: 'Operacao em Tempo Real', description: 'Entrada, saida, presentes e pendencias', icon: DoorOpen, permissions: ['asset-security:view', 'asset-security:entry', 'asset-security:exit'] },
      { href: '/seguranca-patrimonial?tab=people', label: 'Pessoas e Veiculos', description: 'Visitantes, prestadores, motoristas e veiculos', icon: CarFront, permissions: ['asset-security:view'] },
      { href: '/seguranca-patrimonial?tab=authorizations', label: 'Autorizacoes', description: 'Pre-cadastros, convites e QR Codes', icon: ShieldCheck, permissions: ['asset-security:view', 'asset-security:authorize'] },
      { href: '/seguranca-patrimonial?tab=rounds', label: 'Rondas e Ocorrencias', description: 'Rondas, postos, ocorrencias e livro eletronico', icon: RadioTower, permissions: ['asset-security:view', 'asset-security:rounds', 'asset-security:incident'] },
      { href: '/seguranca-patrimonial?tab=assets', label: 'Materiais e Chaves', description: 'Materiais, cargas, chaves, crachas e correspondencias', icon: KeyRound, permissions: ['asset-security:view', 'asset-security:update'] },
      { href: '/seguranca-patrimonial?tab=settings', label: 'Configuracoes', description: 'Portarias, postos, regras, documentos e pacote comercial', icon: PackageCheck, permissions: ['asset-security:manage', 'asset-security:view'] },
    ],
  },
  {
    heading: 'Relatórios',
