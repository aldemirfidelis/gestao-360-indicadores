...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    description: 'Sistema de gestão da qualidade: documentos, processos, auditorias, não conformidades e riscos',
    intent: 'management',
    icon: ShieldCheck,
    items: [
      // Ordenado pelo ciclo do SGQ: documentar -> mapear -> verificar -> tratar -> gerir risco.
      ...
      { href: '/processes', label: 'Processos e SIPOC', description: 'Mapeamento SIPOC, fluxo, responsáveis e análise de processos', icon: Network, permissions: ['processes:view'], exact: true },
      { href: '/forms', label: 'Formulários e Checklists', description: 'Modelos, listas de verificação, inspeções e preenchimentos', icon: FileSpreadsheet, permissions: ['forms:view'] },
      ...
      { href: '/risks', label: 'Riscos', description: 'Matriz de risco, score inerente/residual e mitigações', icon: AlertTriangle, permissions: ['risks:view'] },
      { href: '/central-impactos', label: 'Análise de Impacto', description: 'Análise 360° e simulações de impacto de mudanças', icon: AlertTriangle, permissions: ['vision360:view'] },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/cargos-salarios/equidade', label: 'Equidade Salarial', description: 'Gap de gênero e transparência salarial (Lei 14.611)', icon: Scale, permissions: ['compensation:view', 'org:positions:view'] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/servico-pessoal/recrutamento', label: 'Recrutamento e Seleção', description: 'Requisições de vaga, aprovações e travas de quadro/orçamento', icon: UserPlus, permissions: ['recruit:view'] },
  ...
  {
    heading: 'Suprimentos',
    description: 'Compras, estoque, recebimentos e almoxarifados',
    intent: 'management',
    icon: Truck,
    permissions: ['compras:view', 'compras:request', 'compras:buy', 'compras:approve', 'compras:manage', 'estoque:view', 'estoque:withdraw', 'estoque:operate', 'estoque:approve', 'estoque:transfer', 'estoque:adjust', 'estoque:manage'],
    items: [
      { href: '/suprimentos?tab=dashboard', label: 'Painel', description: 'Visão operacional de compras e estoque', icon: Gauge, permissions: ['compras:view', 'compras:approve', 'compras:manage', 'estoque:view', 'estoque:manage'] },
      { href: '/suprimentos?tab=requisitions', label: 'Requisições', description: 'Minhas solicitações e fila do comprador', icon: ClipboardCheck, permissions: ['compras:view', 'compras:request', 'compras:buy'] },
      { href: '/suprimentos?tab=orders', label: 'Pedidos', description: 'Alçadas, envio e acompanhamento de entregas', icon: Truck, permissions: ['compras:view', 'compras:buy', 'compras:approve', 'compras:manage'] },
      { href: '/suprimentos?tab=stock', label: 'Estoque', description: 'Posição, custo médio e kardex', icon: PackageCheck, permissions: ['estoque:view', 'estoque:transfer', 'estoque:adjust', 'estoque:manage'] },
      { href: '/suprimentos?tab=warehouse', label: 'Almoxarifado', description: 'Retiradas, atendimento e baixa', icon: Download, permissions: ['estoque:view', 'estoque:withdraw', 'estoque:operate'] },
      { href: '/suprimentos?tab=registrations', label: 'Cadastros', description: 'Itens, fornecedores, almoxarifados e alçadas', icon: Settings, permissions: ['compras:manage', 'estoque:manage'] },
    ],
  },
  {
    heading: 'Comunicação',
