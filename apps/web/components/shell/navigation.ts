...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/comunicacao', label: 'Comunicação Organizacional', description: 'Comunicados, campanhas, mural, pesquisas e chat corporativo', icon: Megaphone, permissions: ['communication:view'] },
      ...
      { href: '/seguranca-patrimonial', label: 'Segurança Patrimonial', description: 'Portarias, acessos, rondas, ocorrências e permanência', icon: ShieldCheck, permissions: ['asset-security:view'], exact: true },
      ...
      { href: '/monthly-results', label: 'Reunião Mensal', description: 'Fechamento de resultados, pauta, ata e acompanhamento semanal', icon: Presentation, permissions: ['monthly:view'] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/gestao-premio/colaboradores', label: 'Colaboradores Elegíveis', description: 'Base elegível por competência (Apdata), retrato e conciliação', icon: UserCheck, permissions: ['prize:view'] },
