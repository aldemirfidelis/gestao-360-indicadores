...
export const navSections: NavSection[] = [
  {
    ...
    items: [
      ...
      { href: '/tree', label: 'Árvore de Indicadores', description: 'Causalidade entre indicadores macro e micro', icon: Workflow, permissions: ['indicators:view'] },
  ...
  },
  {
    ...
    icon: PencilRuler,
    items: [
      { href: '/results', label: 'Lançar Resultado', description: 'Realizado mensal dos indicadores', icon: TrendingUp, permissions: ['results:launch'] },
...
export const mobileNavItems: NavItem[] = [
  ...
  { href: '/results', label: 'Lançar', icon: TrendingUp, permissions: ['results:launch'] },
