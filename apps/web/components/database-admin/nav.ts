...
export const dbAdminNav: DbAdminNavItem[] = [
  { href: DB_ADMIN_BASE, label: 'Visão Geral', description: 'Dashboard técnico do banco', icon: Database },
  ...
  { href: `${DB_ADMIN_BASE}/backups`, label: 'Backup e Restauração', description: 'Snapshots lógicos e PITR', icon: Archive },
