...
function EntryDialog({ optionValues, onCreatePerson, onClose, onSaved }: { optionValues: Options; onCreatePerson: (defaults: AnyRecord) => void; onClose: () => void; onSaved: () => void }) {
...
function personDialog(options: Options, current?: AnyRecord, defaults?: AnyRecord): EntityDialogState {
