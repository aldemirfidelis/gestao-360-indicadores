...
export const CATALOG_PAGES: CatalogPage[] = [
  ...
  { code: 'compensation.overview', moduleCode: 'compensation', name: 'Visao Geral', title: 'Cargos e Salarios', route: '/cargos-salarios' },
  ...
  { code: 'compensation.jobs', moduleCode: 'compensation', name: 'Catalogo de Cargos', title: 'Catalogo de Cargos', route: '/cargos-salarios/catalogo' },
