...
export const CATALOG_MODULES: CatalogModule[] = [
  { code: 'communication', name: 'Comunicação', category: 'Comunicação', route: '/comunicacao', menuOrder: 8, criticality: 'medium' },
  { code: 'directory', name: 'Pessoas', category: 'Comunicação', route: '/pessoas', menuOrder: 9, criticality: 'low' },
  { code: 'integrations', name: 'Integrações', category: 'Comunicação', route: '/integracoes', menuOrder: 10, criticality: 'medium' },
  { code: 'help-center', name: 'Central de Ajuda', category: 'Comunicação', route: '/ajuda', menuOrder: 11, criticality: 'low' },
  ...
  { code: 'compensation', name: 'Cargos e Salários', description: 'Plano de cargos, quadro, tabelas salariais e movimentações', category: 'Gestão', route: '/cargos-salarios', menuOrder: 11, criticality: 'high' },
  ...
  { code: 'food-safety', name: 'Segurança de Alimentos (APPCC)', description: 'FSMS: processos, perigos/PCC, normas, fornecedores e lotes', category: 'Gestão', route: '/seguranca-alimentos', menuOrder: 18, criticality: 'medium' },
  { code: 'automations', name: 'Automações', description: 'Fluxos/workflows: gatilhos, condições, ações e aprovações', category: 'Gestão', route: '/central-automacoes', menuOrder: 18, criticality: 'medium' },
  { code: 'asset-security', name: 'Seguranca Patrimonial e Portarias', category: 'Gestão', route: '/seguranca-patrimonial', menuOrder: 18, criticality: 'high' },
  { code: 'forms', name: 'Formulários', category: 'Gestão', route: '/forms', menuOrder: 18, criticality: 'medium' },
...
export const CATALOG_PAGES: CatalogPage[] = [
  { code: 'communication.main', moduleCode: 'communication', name: 'Comunicação', title: 'Comunicação', route: '/comunicacao' },
  { code: 'directory.list', moduleCode: 'directory', name: 'Pessoas', title: 'Pessoas', route: '/pessoas' },
  { code: 'integrations.main', moduleCode: 'integrations', name: 'Integrações', title: 'Integrações', route: '/integracoes' },
  ...
  { code: 'food-safety.main', moduleCode: 'food-safety', name: 'Segurança de Alimentos', title: 'Segurança de Alimentos (APPCC)', route: '/seguranca-alimentos' },
  { code: 'automations.flows', moduleCode: 'automations', name: 'Fluxos', title: 'Automações', route: '/central-automacoes' },
  { code: 'automations.builder', moduleCode: 'automations', name: 'Construtor de Fluxo', title: 'Construtor de Fluxo', route: '/central-automacoes/fluxos/construtor' },
  { code: 'processes.list', moduleCode: 'processes', name: 'Processos', title: 'Processos e SIPOC', route: '/processes' },
  { code: 'asset-security.main', moduleCode: 'asset-security', name: 'Seguranca Patrimonial', title: 'Seguranca Patrimonial e Portarias', route: '/seguranca-patrimonial' },
  { code: 'compensation.overview', moduleCode: 'compensation', name: 'Visão Geral', title: 'Cargos e Salários', route: '/cargos-salarios' },
  { code: 'compensation.structure', moduleCode: 'compensation', name: 'Estrutura e Quadro', title: 'Estrutura e Quadro', route: '/cargos-salarios/estrutura-quadro' },
  { code: 'compensation.jobs', moduleCode: 'compensation', name: 'Catálogo de Cargos', title: 'Catálogo de Cargos', route: '/cargos-salarios/catalogo' },
  { code: 'compensation.salary-fit', moduleCode: 'compensation', name: 'Enquadramento Salarial', title: 'Enquadramento Salarial', route: '/cargos-salarios/enquadramento' },
  { code: 'forms.list', moduleCode: 'forms', name: 'Formulários', title: 'Formulários e Checklists', route: '/forms' },
...
export const CATALOG_FEATURES: CatalogFeature[] = [
  ...
  { code: 'integrations.preference', moduleCode: 'integrations', name: 'Configurar preferências de integração' },
  ...
  { code: 'asset-security.exit', moduleCode: 'asset-security', name: 'Registrar saída' },
  { code: 'asset-security.authorize', moduleCode: 'asset-security', name: 'Gerenciar autorizações' },
  { code: 'asset-security.rounds', moduleCode: 'asset-security', name: 'Executar rondas' },
  { code: 'asset-security.offline', moduleCode: 'asset-security', name: 'Operação offline', criticality: 'high' },
  { code: 'compensation.salary.individual', moduleCode: 'compensation', name: 'Visualizar salário individual', criticality: 'critical' },
  { code: 'compensation.movements.approve', moduleCode: 'compensation', name: 'Aprovar movimentações', criticality: 'high' },
  { code: 'compensation.export', moduleCode: 'compensation', name: 'Exportar dados de cargos e salários', criticality: 'high' },
  { code: 'forms.create', moduleCode: 'forms', name: 'Criar formulário/checklist' },
  { code: 'forms.update', moduleCode: 'forms', name: 'Editar campos e registrar preenchimento' },
  { code: 'forms.delete', moduleCode: 'forms', name: 'Excluir formulário', criticality: 'high' },
