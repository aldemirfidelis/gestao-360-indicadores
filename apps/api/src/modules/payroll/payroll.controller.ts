...
export class PayrollController {
  ...
  /** Leitura liberada a quem vê a folha: telas de lote mostram o status de conferência. */
  @Get('company-settings')
  @RequirePermissions('folha:view')
  getCompanySettings(@CurrentUser() me: AuthPayload) {
    return this.runs.getCompanySettings(me);
  }

  @Patch('company-settings')
  @RequirePermissions('folha:params')
  updateCompanySettings(@CurrentUser() me: AuthPayload, @Body() body: any) {
    return this.runs.updateCompanySettings(me, body);
  }
